...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 06-11-2014 a las 23:58:51
...
CREATE TABLE IF NOT EXISTS `activo1` (
  ...
  PRIMARY KEY (`Documento`,`Cedula`,`Codigo`),
  KEY `Cedula` (`Cedula`)
...
CREATE TABLE IF NOT EXISTS `costos` (
  ...
  `Descripcion` varchar(255) COLLATE utf8_spanish_ci NOT NULL,
  `Valor` int(11) NOT NULL,
  PRIMARY KEY (`Documento`,`Codigo`,`Cedula`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
...
CREATE TABLE IF NOT EXISTS `factura` (
  ...
  `total` int(11) DEFAULT NULL,
  PRIMARY KEY (`num_factura`,`cliente`),
  KEY `cliente` (`cliente`)
...
CREATE TABLE IF NOT EXISTS `gasto` (
  ...
  `Valor` int(11) NOT NULL,
  KEY `Cedula` (`Cedula`),
  KEY `Documentado` (`Documento`,`Cedula`,`Codigo`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
...
CREATE TABLE IF NOT EXISTS `producto_proveedor` (
  ...
  PRIMARY KEY (`cod_poducto`),
  KEY `codgio_proveedor` (`cod_proveedor`,`cod_poducto`),
  KEY `cod_poducto` (`cod_poducto`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
